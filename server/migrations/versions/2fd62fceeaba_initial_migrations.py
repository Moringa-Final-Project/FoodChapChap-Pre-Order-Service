...
Revision ID: 2fd62fceeaba
Revises: 
Create Date: 2023-07-27 22:19:43.251320
...
def upgrade():
    ...
    sa.Column('admin_id', sa.Integer(), nullable=False),
    sa.Column('customer_username', sa.String(length=100), nullable=False),
    ...
    op.create_table('restaurant_promotions',
    sa.Column('restaurant_id', sa.Integer(), nullable=False),
    sa.Column('promotion_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['promotion_id'], ['promotions.promotion_id'], ),
    sa.ForeignKeyConstraint(['restaurant_id'], ['restaurants.restaurant_id'], ),
    sa.PrimaryKeyConstraint('restaurant_id', 'promotion_id')
    )
