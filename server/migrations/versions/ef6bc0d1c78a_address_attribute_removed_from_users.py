"""Address attribute removed from users

Revision ID: ef6bc0d1c78a
Revises: 
Create Date: 2023-08-03 14:15:24.156245
...
def upgrade():
    ...
    sa.Column('customization_options', sa.String(length=100), nullable=False),
    ...
    sa.ForeignKeyConstraint(['user_id'], ['users.user_id'], name='fk_user_id_restaurants'),
